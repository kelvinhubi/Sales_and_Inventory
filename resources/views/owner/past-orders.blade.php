                ...
                <div class="card">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form method="POST" action="{{ route('owner.past-orders.destroy', $pastOrder) }}" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete this past order?')">
                                            @csrf
                                            @method('DELETE')
                    ...
                    <div class="card-footer clearfix">
                        ...
                        <div class="float-right">
                            <div class="mb-2">
                                <form id="exportSelectedForm" method="GET" action="{{ route('owner.past-orders.exportSelected') }}" style="display:inline;" class="mr-2">
                                ...
                                <form id="summaryReportForm" method="GET" action="{{ route('owner.past-orders.summaryReport') }}" style="display:inline;">
                                ...
                                <form id="deleteSelectedForm" method="POST" action="{{ route('owner.past-orders.deleteSelected') }}" style="display:inline;">
                                    @csrf
